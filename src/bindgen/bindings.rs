...
use crate::bindgen::language_backend::{CLikeLanguageBackend, CythonLanguageBackend, LanguageBackend, POULanguageBackend};
...
pub struct Bindings {
    ...
    /// Bindings are generated by a recursive call to poubindgen
...
impl Bindings {
    ...
    pub fn write<F: Write>(&self, file: F) {
        match self.config.language {
            ...
            Language::POU => { self.write_with_backend(file, &mut POULanguageBackend::new(&self.config)) }
        }
    }
